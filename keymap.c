...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_HOME]  = ACTION_TAP_DANCE_DOUBLE(KC_HOME, KC_LGUI),
  [TD_PGDN]  = ACTION_TAP_DANCE_DOUBLE(KC_PGDN, KC_RGUI)
};
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,   KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   TG(_NUMBR),         KC_MUTE,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,   KC_RGUI,
           KC_HOME, KC_END, KC_ESCNAV,  KC_SPC,  KC_LCTL,                   KC_ENT,   KC_BSPC, KC_DEL,   KC_PGUP, KC_PGDN
),
