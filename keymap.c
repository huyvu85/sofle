 ...
 * Workman
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |  F1  |  F2  |  F3  |  F4  |  F5  |                    |  F6  |  F7  |  F8  |  F9  | F10  | Print|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_NUMBR] = LAYOUT(
  ...
  SAGR(KC_EQL),  KC_SCLN, KC_4,  KC_5,  KC_6,  KC_EQL,                            XXXXXXX, KC_RSFT, KC_RCTL,KC_RALT,KC_ALGR,XXXXXXX,
  XXXXXXX,       KC_GRV,  KC_1,  KC_2,  KC_3,  KC_BSLS, XXXXXXX,       XXXXXXX, XXXXXXX,XXXXXXX, KC_COMM,KC_DOT, KC_SLSH,XXXXXXX,
           TG(_NUMBR), MEH(KC_NO), KC_DOT, KC_0, KC_MINS,                  KC_ENT, KC_BSPC, KC_DEL, XXXXXXX, XXXXXXX
),
/* Symbol
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |  ²   |  ³   |  £   |  €   |                    |      |      |      |      |      |      |
 ...
 */
[_SYMBL] = LAYOUT(
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, ALGR(KC_3), ALGR(KC_5),                    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
