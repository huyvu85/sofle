...
tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_PASTE]  = ACTION_TAP_DANCE_DOUBLE(C(KC_V), KC_DEL),
};
 ...
 *          | 'NUM'| 'MEH'| 'NAV' |      |/ 'CTRL' /         \'SYMBL'\|'NUM'  |'FUN' |'MEH' |      |
 *           `------------------------------------'           '-------'----------------------------'
 */
[_WORKMAN] = LAYOUT(
  ...
  UNDO,          KC_Z,         KC_X,         KC_M,         KC_C,         KC_V,   KC_QWERTY,                KC_MUTE, KC_K,    KC_L,         KC_COMM,      KC_DOT,       KC_SLSH,       REDO,
                               HOME,         END,       KC_ESCNAV,    KC_SPC, LCTL_T(KC_TAB),            KC_ENTSYM, KC_BSNM, KC_DELFUN,    PGUP,         RGUI_T(KC_PGDN)
),
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,   KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   KC_WORKMAN,         KC_MUTE,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,   KC_RSFT,
       HOME, KC_END, KC_ESC,  KC_SPC,  KC_LCTL,                      KC_ENT,   KC_BSPC, KC_DEL,  KC_PGUP, RGUI_T(KC_PGDN)
),
...
[_NUMBR] = LAYOUT(
  ...
  XXXXXXX,  KC_LCBR, KC_7,  KC_8,  KC_9,  KC_RCBR,                           XXXXXXX, XXXXXXX, XXXXXXX,XXXXXXX,XXXXXXX,KC_F12,
 ...
 */
[_SYMBL] = LAYOUT(
  XXXXXXX, SAGR(KC_EQL), ALGR(KC_2), ALGR(KC_3), SAGR(KC_4), ALGR(KC_5),        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, ALGR(KC_EQL), KC_AMPR, KC_ASTR, KC_LBRC, KC_RBRC,                          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
 ...
 */
[_NAV] = LAYOUT(
  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                       KC_MYCM, KC_CALC, KC_MAIL, KC_LPAD,      KC_PWR, KC_SLEP,
